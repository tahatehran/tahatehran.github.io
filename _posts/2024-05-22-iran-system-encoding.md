...
dir: rtl
author: MovtiGroup
description: "کتابخانه پایتون حرفه‌ای و با کارایی بالا برای کدگذاری قدیمی ایران سیستم."
---
...
- **مرتب‌سازی بصوی دقیق:** اجرای دقیق الگوریتم‌های Reshaping و Layout بصری.
